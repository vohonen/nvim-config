...
require('packer').startup(function()
	...
	use {'nvim-telescope/telescope.nvim', 			-- UI to find and open files
	...
	use 'tpope/vim-surround'						-- surround text with smth
	...
	use 'lunarvim/colorschemes'						-- vimscript colorschemes
